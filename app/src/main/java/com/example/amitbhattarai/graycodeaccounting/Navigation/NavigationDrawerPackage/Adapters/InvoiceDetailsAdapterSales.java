...
public class InvoiceDetailsAdapterSales extends ArrayAdapter<InvoiceModel> {
    ...
    public InvoiceDetailsAdapterSales(Context context, ArrayList<InvoiceModel> time) {
        super(context, R.layout.custom_invoice_detail_row_sales, time);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Log.d(TAG, "getView: ");
        View view = mInflater.inflate(R.layout.custom_invoice_detail_row_sales, parent, false);
